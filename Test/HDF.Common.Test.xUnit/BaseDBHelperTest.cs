...
";
            ...
            Assert.Equal(1, helper.ExecuteNonQuery("insert into test values('1')"));
            ...
            param = helper.CreateParameter("@id", "1");
            Assert.Equal(1, helper.ExecuteNonQueryInTran("delete from test where '1'=@id", i => i > 0, CommandType.Text, param));
            Assert.Equal(1, helper.ExecuteNonQueryInTran("insert into test values('2')", i => false));
